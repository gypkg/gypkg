...
Server.prototype.generate = function generate(gyp, extra, callback) {
  this.listen(this.GYPKG_CMD_PORT, this.GYPKG_CMD_HOST, () => {
    this.GYPKG_CMD_PORT = this.address().port;
    this.GYPKG_CMD_HOST = this.address().address;

    this.log(`(Listening on ${this.GYPKG_CMD_HOST}:${this.GYPKG_CMD_PORT})`);
...
Server.prototype._generate = function _generate(gyp, extra, callback) {
  ...
  env.GYPKG_CMD_HOST = this.GYPKG_CMD_HOST;
  env.GYPKG_CMD_PORT = this.GYPKG_CMD_PORT;
